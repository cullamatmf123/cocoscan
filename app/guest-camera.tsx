  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.distanceGuide}>
        <Text style={styles.distanceTitle}>📏 Capture Distance Guide</Text>
        <View style={styles.distanceRow}>
          <Text style={styles.distanceItem}>Boreholes: 0.5–1m</Text>
          <Text style={styles.distanceDot}>•</Text>
          <Text style={styles.distanceItem}>V-cuts: 1–2m</Text>
          <Text style={styles.distanceDot}>•</Text>
          <Text style={styles.distanceItem}>Whole palm: 3–5m</Text>
        </View>
      </View>
