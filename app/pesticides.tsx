    ...
    <View style={s.root}>
      <ScrollView style={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.hero}>
          ...
          {/* Header (aligned like result.tsx: spacing/padding/layout) */}
          ...
          <View style={s.heroText}>
            <View style={s.heroPill}>
              <Text style={s.heroPillText}>PEST MANAGEMENT</Text>
            </View>
          ...
          <View style={s.zoomBackdrop}>
            <TouchableWithoutFeedback>
              <View style={s.zoomContainer}>
                {zoomedImage && <Image source={zoomedImage} style={s.zoomImage} resizeMode="contain" />}
...
const s = StyleSheet.create({
  ...
  // App Bar (same spacing/layout style as result.tsx)
  appBar: {
    paddingTop: 48,
  ...
  zoomClose: { position: 'absolute', top: 12, right: 12 },
  zoomCloseInner: {
    width: 36,
    height: 36,
    borderRadius: 18,
